document.addEventListener("DOMContentLoaded", () => {
  ...
  // Persists the user's choice to hide the onboarding Quick Start card via
  // localStorage so they don't see it again on subsequent visits. The
  // real-time session validity panel (renderSessions) is untouched.
