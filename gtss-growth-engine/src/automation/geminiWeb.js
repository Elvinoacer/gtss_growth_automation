...
module.exports = { generateImageViaGeminiWeb, generateTextViaGeminiWeb, generateImageAwareCaptionViaGeminiWeb };
...
// This lets the user get product-specific captions that actually match the
// image content (instead of a generic text-only prompt that has no idea
